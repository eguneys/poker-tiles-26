...
export function go_queen(square: Square) {
  if (square % 8 !== 0) {
    return square - 1
  }
}

export function go_king(square: Square) {
  if ((square + 1) % 8 !== 0) {
    return square + 1
  }
}

export function go_black(square: Square) {
  if (square + 8 < 64) {
    return square + 8
  }
}

export function go_white(square: Square) {
  if (square - 8 >= 0) {
    return square - 8
  }
}
...
export function get_king_squares(o: Square) {
